...
export default function Side() {
  ...
  return (
    <div className="h-100% p-4">
      {/* <!--search icon--> */}
      <div className="bg-gray-100 flex rounded-2xl hover:cursor-pointer mb-4 h-12 p-4 focus:border-2 focus:border-black sticky top-0 dark:bg-gray-600">
      ...
      {/* <!-- Get verified--> */}
      <div class="h-32 font-bold space-y-2 rounded-lg p-2 bg-gray-100 border-2 mb-2 dark:bg-gray-600">
        <h1>Get verified</h1>
      ...
      {/* trends */}
      <div className="bg-gray-100 h-100% rounded-lg border-2 dark:bg-gray-600">
